  ...
  ({ className, children, color }, ref) => {
    return (
      <div
        ...
        className={cn(
          "z-10 flex size-16 max-sm:size-12 items-center justify-center rounded-full  transition-color duration-300",
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "z-20 flex h-fit pb-3 w-64 max-sm:w-36 max-lg:w-56 items-stretch overflow-hidden rounded-3xl bg-card/50 backdrop-blur-xs border-b inset-shadow-xs inset-shadow-white/20",
        ...
        <div className="flex w-6 flex-col items-center justify-start gap-1.5 border-l border-border/50 max-sm:hidden p-4">
        ...
        <div className="flex flex-1 flex-col justify-between p-5 max-sm:p-1 max-sm:px-4 text-left">
          <div className="flex items-center justify-start gap-2 sm:hidden p-2">
            <span className="size-2.5 rounded-full bg-[#FF5F56] shadow-inner" />
            <span className="size-2.5 rounded-full bg-[#FFBD2E] shadow-inner" />
            <span className="size-2.5 rounded-full bg-[#27C93F] shadow-inner" />
          </div>
          <div>
            <div className="mb-4 flex items-center justify-between">
              <div>
                <div className="text-[10px] font-bold max-sm:text-[8px] max-sm:font-normal tracking-[0.25em] text-muted-foreground uppercase">
                  Engine Core
                </div>
                <div className="mt-1 max-sm:text-xs text-base  max-sm:font-normal font-extrabold sm:tracking-tight text-secondary-foreground">
                  Frontend Craft
                </div>
              </div>
          ...
          {/* دکمه‌های پایینی */}
          <div className="grid grid-cols-2 gap-2 pt-2 max-sm:hidden">
...
export function FrontendVisual({ className }: { className?: string }) {
  ...
  return (
    <div
      ...
      <div className="relative flex  size-full max-w-6xl items-center justify-between gap-12 max-lg:gap-5">
        {/* ستون نودهای ورودی */}
        <div className="flex flex-col   gap-5">
          <Node
            ref={uiRef}
            color="rgba(14, 165, 233, 0.4)"
            className="size-16 max-sm:size-12 border-sky-200">
            <div className="flex flex-col items-center text-center">
              <span className="text-xl max-sm:text-sm">✨</span>
              <span className="mt-1 text-[11px] max-sm:text-[8px] max-sm:font-normal font-bold tracking-wide text-sky-600">
                UI/UX
              </span>
            </div>
          </Node>
          ...
          <Node
            ...
            className="size-16 max-sm:size-12 border-purple-600/20">
            <div className="flex flex-col items-center text-center">
              <span className="text-xl max-sm:text-md">
                <FcDocument   className="max-sm:size-4" />
              </span>
              <span className="mt-1 text-[11px] max-sm:text-[8px] max-sm:font-normal font-bold tracking-wide text-purple-600">
                seo
              </span>
            </div>
          </Node>
          ...
          <Node
            ...
            className="size-16 max-sm:size-12 border-cyan-200">
            <div className="flex flex-col items-center text-center">
              <span className="text-xl max-sm:text-md font-bold  text-cyan-600">
                <FaReact className="max-sm:size-4"  />
              </span>
              <span className="mt-1 text-[11px] max-sm:text-[8px] max-sm:font-normal font-bold tracking-wide text-cyan-600">
                React
              </span>
            </div>
          </Node>

          {/* <Node ref={a11yRef} color="rgba(249, 115, 22, 0.4)" className="size-16 max-sm:size-12 border-orange-200">
             <div className="flex flex-col items-center text-center">
              <span className="text-xl max-sm:text-md">♿</span>
              <span className="mt-1 text-[11px] max-sm:text-[8px] max-sm:font-normal font-bold tracking-wide text-orange-950">A11y</span>
            </div>
          </Node> */}
          ...
          <Node
            ...
            className="size-16 max-sm:size-12 border-green-200">
            <div className="flex flex-col items-center text-center">
              <span className="text-xl max-sm:text-sm">🚀</span>
              <span className="mt-1 text-[11px] max-sm:text-[8px] max-sm:font-normal font-bold tracking-wide text-green-600">
                Perf
              </span>
            </div>
          </Node>
        ...
        <div className="flex flex-col items-center justify-center gap-5">
          <Node
            ref={userRef}
            className="size-20 max-sm:size-13 backdrop-blur-xs border-b-[0.2px] ">
            <div className="flex flex-col items-center leading-none ">
              <span className="text-3xl max-sm:text-sm">🧑‍💻</span>
              <span className="mt-2 text-xs max-sm:text-[8px] font-bold text-secondary-foreground">
                User
              </span>
            </div>
          </Node>
          ...
          <div className="flex flex-col items-center gap-1.5 max-w-[180px] text-center max-sm:hidden">
            <div className="flex items-center gap-2">
